...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartVO> SaveOurUpdateCart(CartVO cartVO)
        {
            ...
            else
            {
                ...
                var cartDeatail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(d =>
                    d.ProductId == cartVO.CartDetails.FirstOrDefault().ProductId
                ...
                else
                {
                    ...
                    cart.CartDetails.FirstOrDefault().Product = null;
                    cart.CartDetails.FirstOrDefault().Count += cartDeatail.Count;
                    cart.CartDetails.FirstOrDefault().Id = cartDeatail.Id;
                    cart.CartDetails.FirstOrDefault().CartHeaderId = cartDeatail.CartHeaderId;
